...
const Hasil = () => {
  return (
    <div>
      <div className='w-full bg-blue-50 hover:bg-blue-100 rounded-lg shadow-sm hover:shadow-lg p-6 transition duration-500 ease-in-out text-gray-600'>
        <p className='text-xl font-semibold mb-4'>Hasil</p>
